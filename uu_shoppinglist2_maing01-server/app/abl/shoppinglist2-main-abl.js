...
const Errors = require("../api/errors/shoppinglist2-main-error.js");
...
const logger = LoggerFactory.get("Shoppinglist2MainAbl");

class Shoppinglist2MainAbl {
  constructor() {
  ...
  async init(uri, dtoIn, session) {
    ...
    // HDS 2
    const schemas = ["shoppinglist2Main"];
    ...
    if (dtoIn.uuBtLocationUri) {
      ...
      const createAwscDtoIn = {
        name: "UuShoppinglist2",
        typeCode: "uu-shoppinglist2-maing01",
        location: location,
...
module.exports = new Shoppinglist2MainAbl();
